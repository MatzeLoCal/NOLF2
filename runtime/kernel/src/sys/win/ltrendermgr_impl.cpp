...
// The render manager is the D3D9 render-target / D3DX effect-shader controller:
// every method drives the global g_Device and the D3D resource interfaces, none
// of which exist in the macOS null-renderer build. These stubs report
// "unavailable"; the GL renderer (Phase 2) will provide the real implementation.
void CLTRenderMgr::Init() {}
void CLTRenderMgr::Term() {}

LTRESULT CLTRenderMgr::AddEffectShader(const char *, int, const uint32 *, uint32, HEFFECTPOOL) { return LT_ERROR; }
...
LTRESULT CLTRenderMgr::CreateRenderTarget(uint32, uint32, ERenderTargetFormat, EStencilBufferFormat, HRENDERTARGET) { return LT_ERROR; }
...
LTRESULT CLTRenderMgr::GetRenderTargetDims(HRENDERTARGET, uint32 &nWidth, uint32 nHeight) { return LT_ERROR; }

LTRESULT CLTRenderMgr::StoreDefaultRenderTarget() { return LT_ERROR; }
LTRESULT CLTRenderMgr::RestoreDefaultRenderTarget() { return LT_ERROR; }
...
LTRESULT CLTRenderMgr::SnapshotCurrentFrame() { return LT_ERROR; }
LTRESULT CLTRenderMgr::SaveCurrentFrameToPrevious() { return LT_ERROR; }
