...
#ifndef LT_MACOS
// Win32 DLL entry point. It does nothing but fall through, and macOS dylibs
// have no equivalent notification, so it is simply dropped here rather than
// given a stub (see the "pure macOS port" rule in macbuild/CMakeLists.txt).
