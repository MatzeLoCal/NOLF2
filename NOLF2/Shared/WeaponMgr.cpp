...
void WEAPON::InitMembers( CButeMgr &buteMgr, char *aTagName )
{
	...
	if( nAmmoIdCount )
	{
		...
		// If every listed ammo failed to resolve, n is 0 and aAmmoIds may be a
		// zero-length (or null) allocation — don't read through it.
		nDefaultAmmoId = (n > 0 && aAmmoIds) ? aAmmoIds[0] : WMGR_INVALID_ID;
	}
