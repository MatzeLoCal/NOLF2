// ----------------------------------------------------------------------- //
//
// MODULE  : render_convar.h
//
// PURPOSE : Registration of the renderer console variables declared in
//           rendererconsolevars.h. See render_convar.cpp for why this matters —
...
//
// ----------------------------------------------------------------------- //
#ifndef __RENDER_CONVAR_H__
#define __RENDER_CONVAR_H__
