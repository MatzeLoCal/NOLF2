...
class CAISenseRecorderAbstract : public ILTObjRefReceiver
{
	public : // Public methods
		...
		// Virtual: instances are deleted through this abstract base (CAI's dtor);
		// a non-virtual dtor there is UB, which clang compiles to a trap.
