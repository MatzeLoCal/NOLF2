...
#ifndef LT_MACOS
#include "d3d_texture.h"   // glyph-texture upload (Win32 GDI/D3D path only)
#endif
#include <algorithm>
...
#ifndef LT_MACOS  // ---- Win32 GDI glyph rasterization (macOS stub is below) ----
...
#endif // !LT_MACOS  (GetUniqueCharList below is portable and stays compiled)
...
#ifndef LT_MACOS  // ---- more Win32 GDI glyph rasterization ----
...
#endif // !LT_MACOS  (end of Win32 GDI glyph rasterization helpers)
...
{
#ifdef LT_MACOS
	// Glyph rasterization uses Win32 GDI (CreateFontIndirect / GetGlyphOutline)
	// plus a D3D glyph texture; on macOS this needs a CoreText + GL path, which
	// is a Phase 2/3 task. Report failure (no bitmap font) for now.
	(void)pszString; (void)Font;
	FreeData();
	return false;
#else
