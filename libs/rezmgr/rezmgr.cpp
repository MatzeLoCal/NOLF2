...
#if defined(LT_MACOS)
// The compat layer provides REAL implementations: _splitpath and the _MAX_*
// limits via the force-included msvc_crt_compat.h, and the _findfirst family
// via <io.h> (opendir/fnmatch-based). The old placeholder block below ASSERTed
// on _splitpath and made _findfirst always fail (directory rez trees would
