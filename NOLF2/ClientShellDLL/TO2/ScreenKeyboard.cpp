...
LTBOOL CScreenKeyboard::Build()
{
	...
	//background frame
	LTRect frameRect = g_pLayoutMgr->GetScreenCustomRect(SCREEN_ID_KEYBOARD,"FrameRect");
...
uint32 CScreenKeyboard::OnCommand(uint32 dwCommand, uintptr_t dwParam1, uintptr_t dwParam2)
{
	switch(dwCommand)
	{
	case CMD_UPDATE:
